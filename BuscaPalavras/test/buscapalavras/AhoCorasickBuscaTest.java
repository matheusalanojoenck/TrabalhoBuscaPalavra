...
public class AhoCorasickBuscaTest {
    ...
    public void testExecuteCase1() {
        assertEquals(true, aho.execute(LerArquivo.getTextoCompleto(), "way".toUpperCase()));
    }
    ...
    public void testExecuteCase2() {
        assertEquals(true, aho.execute(LerArquivo.getTextoCompleto(), "HELEN, a gentlewoman of Rossillion".toUpperCase()));
    }
    ...
    public void testExecuteCase3() {
        assertEquals(true, aho.execute(LerArquivo.getTextoCompleto(), "HELEN, a gentlewoman of Rossillion BERTRAM, Count of Rossillion".toUpperCase()));
    }
    ...
    public void testExecuteCase6(){
        assertEquals(false, aho.execute(LerArquivo.getTextoCompleto(), "HELEN, a gentlewoman of RossillionX".toUpperCase()));
    }
}
